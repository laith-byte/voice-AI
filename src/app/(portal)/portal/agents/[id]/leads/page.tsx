        ...
        <DialogContent>
          ...
          <div className="space-y-4 py-4">
            ...
            <div className="space-y-2 pt-4 border-t">
              <Label>Tagging Webhook</Label>
              <p className="text-xs text-muted-foreground">
                Send a POST request to tag leads from your CRM
              </p>
              <Input
                readOnly
                value="POST /api/leads/tag"
                className="bg-muted font-mono text-xs h-8"
              />
              <div className="text-xs text-muted-foreground space-y-1 mt-2">
                <p className="font-medium">Headers:</p>
                <code className="block bg-muted px-2 py-1 rounded">Authorization: Bearer YOUR_API_KEY</code>
                <p className="font-medium mt-2">Body:</p>
                <code className="block bg-muted px-2 py-1 rounded whitespace-pre">{`{ "phone": "+15551234567", "tags": ["Interested"] }`}</code>
              </div>
            </div>
          </div>
          <DialogFooter>
