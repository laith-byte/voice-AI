...
async function authenticateN8n(request: NextRequest) {
...
// POST — n8n REST Hook subscribe
export async function POST(request: NextRequest) {
  const auth = await authenticateN8n(request);
  if (!auth) {
...
// DELETE — n8n REST Hook unsubscribe
